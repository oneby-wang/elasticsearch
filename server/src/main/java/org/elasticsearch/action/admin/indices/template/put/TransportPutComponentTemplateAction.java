...
public class TransportPutComponentTemplateAction extends AcknowledgedTransportMasterNodeAction<PutComponentTemplateAction.Request> {
    ...
    protected void masterOperation(
        ...
        final ComponentTemplate existing = project.componentTemplates().get(request.name());
        if (existing != null) {
            if (request.create()) {
        ...
        try {
            indexTemplateService.validateComponentTemplate(request.name(), componentTemplate);
        } catch (Exception e) {

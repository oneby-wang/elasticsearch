...
public class MetadataIndexTemplateServiceTests extends ESSingleNodeTestCase {
    ...
    public void testValidateComponentTemplate() throws Exception {
        MetadataIndexTemplateService metadataIndexTemplateService = getMetadataIndexTemplateService();
        ...
        expectThrows(
            ...
            () -> metadataIndexTemplateService.validateComponentTemplate("foo2", componentTemplate2)
        );
        ...
        expectThrows(
            ...
            () -> metadataIndexTemplateService.validateComponentTemplate("foo3", componentTemplate3)
        );
        ...
        expectThrows(
            IllegalArgumentException.class,
            () -> metadataIndexTemplateService.validateComponentTemplate("foo4", componentTemplate4)
        );
    }
